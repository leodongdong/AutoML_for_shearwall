...
# -*- coding=utf-8 -*-
import csv
p = r'/mnt/c/Users/user/Dropbox/Mahchine learning/Shaer Wall prediction/Analysis/Final/cate/PDP/Shear Wall dataset.csv'
...
for feature in categorical_features:
    ...
    data1[:, feature] = le.transform(data[:, feature])
...
dataf['Section_R'] = dataf['Section_R'].astype('int')
dataf['Section_B'] = dataf['Section_B'].astype('int')
dataf['Section_F'] = dataf['Section_F'].astype('int')
...
fig, axes = pdp.pdp_plot(
    pdp_fare, 'Concrete Compressive Strength (MPa)', frac_to_plot=0.5, plot_lines=True, x_quantile=True, show_percentile=True, plot_pts_dist=True
)
